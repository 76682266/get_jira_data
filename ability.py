...
team_ab_201903_201904={
    ...
    'dec_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Yina.Du,Haiyang.Zhou,Neo.Zhu,Abby,BaoBao)',
    ...
    'mobile_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Miley,lianbin.tu,zhaoxingpei,Chenyali,Sissi.Zhao,"Min",Chanda,Chanda,luna,liucheng,xiaoli.Jin,Syrena,Cassie.wang)',
    ...
    'bi_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (panda,haya,jiangfeng,paul.zhang,zhaoxingpei,Miley,qingzhi.bao,gaojing,abbie,pandingling,wangshuyan,katniss,yolanda,katy,wuxinyu,PearlNi)',
    ...
    'fr_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (fiona,paul,jeo,connie,angle,chaofan.sun,okcean,Taylor.mo,Jerry.Qiao)',
    ...
    'sdet_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (april,kara,spruce,corleone,katherine,jiekai.bi,zhangyinga,Daniel.Feng)',
