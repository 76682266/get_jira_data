...
single_ab_201903_201904={
    '1.a':'project in (报表, 决策平台, 图表开发, BI, MOBILE) AND issuetype = 客户BUG AND created >= 2019-03-01 AND created <= 2019-04-30 AND NOT (问题解决方案 is not EMPTY AND 问题解决方案 in (不是bug, 需求处理, 文档优化, 永不修复, 产品改进) AND status in (创建者确认, 被否决)) AND NOT (问题解决方案 is not EMPTY AND 问题解决方案 in (重复BUG) AND status in (创建者验收, 创建者确认, 被否决, 已解决, 验收通过待发布, 产品场景确认)) AND (分支 = MASTER稳定版 OR 分支 is EMPTY) AND NOT status in (重复BUG待解决) AND 责任测试 = ',
...
team_ab_201903_201904={
    ...
    'chart_5.b': 'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Lipei,Doris,Zoey,Alisa,Aloe,Amber,Tingting.Z,LuSun)',
    ...
    'dec_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Yina.Du,Haiyang.Zhou,Neo.Zhu,Abby)',
    'dec_5.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND status = 已解决 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Yina.Du,Haiyang.Zhou,Neo.Zhu,Abby)',
    'mobile_1.c':'filter=12924 AND created >= 2018-11-01 AND created <= 2018-12-31',
    ...
    'mobile_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Miley,lianbin.tu,zhaoxingpei,Chenyali,Sissi.Zhao,"Min",Chanda,Chanda,luna,lioucheng,xiaoli.Jin,Syrena,Cassie.wang)',
    'mobile_5.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND status = 已解决 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (Miley,lianbin.tu,zhaoxingpei,Chenyali,Sissi.Zhao,"Min",Chanda,Chanda,luna,lioucheng,xiaoli.Jin,Syrena,Cassie.wang)',
    ...
    'bi_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (panda,haya,jiangfeng,paul.zhang,qingzhi.bao,gaojing,abbie,pandingling,wangshuyan,katniss,yolanda,katy,wuxinyu,PearlNi)',
    'bi_5.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND status = 已解决 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (panda,haya,jiangfeng,paul.zhang,qingzhi.bao,gaojing,abbie,pandingling,wangshuyan,katniss,yolanda,katy,wuxinyu,PearlNi)',
    ...
    'fr_3.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 客户BUG AND 问题解决方案 in (不是bug) AND status in (创建者确认, 被否决) AND created >= 2019-03-01 AND created <= 2019-04-30 AND 责任测试 in (fiona,paul,jeo,connie,angle,chaofan.sun,okcean,Taylor.mo)',
    'fr_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (fiona,paul,jeo,connie,angle,chaofan.sun,okcean,Taylor.mo)',
    'fr_5.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND status = 已解决 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (fiona,paul,jeo,connie,angle,chaofan.sun,okcean,Taylor.mo)',
    'sdet_5.b':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (april,kara,spruce,corleone,katherine,jiekai.bi,zhangyinga)',
    'sdet_5.c':'project in (BI, REPORT, DEC, CHART, MOBILE) AND issuetype = 开发测试任务 AND status = 已解决 AND created >= 2019-03-01 AND created <= 2019-04-30 AND reporter in (april,kara,spruce,corleone,katherine,jiekai.bi,zhangyinga)'
